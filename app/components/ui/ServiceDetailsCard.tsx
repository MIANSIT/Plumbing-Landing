        ...
        <div className="flex flex-col gap-10">
            {cards.map((card, idx) => (
                ...
                >
                    ...
                    <div className={`absolute -inset-1 bg-gradient-to-r ${card.gradient} rounded-3xl blur-xl opacity-0 group-hover:opacity-20 transition duration-500`} />
                    
                    {/* Card Container */}
                    <div className={`relative flex flex-col lg:flex-row ${idx === 1 ? 'lg:flex-row-reverse' : ''} 
                        ...
                        <div className="relative lg:w-1/2 h-80 lg:h-auto overflow-hidden">
                            ...
                            <div className="absolute top-6 left-6 z-20">
                                <div className={`flex items-center gap-2 px-4 py-2 bg-gradient-to-r ${card.gradient} 
                        ...
                        <div className="flex-1 p-8 lg:p-10 flex flex-col justify-center">
                            ...
                            <div className={`w-16 h-1 bg-gradient-to-r ${card.gradient} rounded-full mb-6 
                        ...
                        <div className={`absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-tl ${card.gradient} 
